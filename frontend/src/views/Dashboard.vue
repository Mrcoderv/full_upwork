...
export default {
  ...
  setup() {
    ...
    const stats = computed(() => role.value === 'student' ? [
      { label: 'Mina kurser', value: 'Se aktuella', note: 'kurser och framsteg' }, { label: 'Inlämningar', value: 'Följ upp', note: 'uppgifter och feedback' }, { label: 'Studieassistent', value: 'Tillgänglig', note: 'för frågor och stöd' }, { label: 'Kalender', value: 'Planera', note: 'möten och deadlines' },
    ] : [
    ...
    return { displayName, roleLabel, greeting, primaryAction, stats, quickLinks }
  },
}
</script>

<style scoped>
.dashboard-page { min-height: 100%; padding: 2rem clamp(1rem, 4vw, 4rem) 4rem; background: #f4f7f5; color: #17352e; }
